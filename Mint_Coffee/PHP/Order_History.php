...
<head>
    ...
    <title>Mint Coffee | Order History</title>
</head>
<body>
<div class="menu_bar">  
    ...
    ?>
<br><br><br><br><br>
<h2 class="header_cart">Order History</h2>
<div class="change_cancel">
    <a class="link_to_cancel" href="/Mint_Coffee/PHP/Order_cancel.php">Order Cancel&nbsp<img src="/Mint_Coffee/Images/up-arrow.png" width="7%" class="arrow"/></a>
</div>
    <div class="products">
    <div class="box-container">
        <?php
        $uid = $_SESSION['user_id'];
            $select_product = mysqli_query($conn,"SELECT * FROM Mint_Coffee.OrderHis WHERE User_ID = '$uid'")or die("Cannot get order");
        ...
        ?><tr class="table_body">
                    ...
                    <td class="Table_data"><?php echo $fetch_product['Time_All'];?></td>
            <tr>
        <?php
                }
                ?>
